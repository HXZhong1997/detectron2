...
CUDA_VISIBLE_DEVICES=$1 python tools/plain_train_net_wG.py --config-file configs/faster-rcnn-g/Net-G-ch-lr1e-2-no2svr.yaml --config-det configs/faster-rcnn-g/voc_faster_rcnn_R_50_FPN_B8.yaml --num-gpus 1 OUTPUT_DIR output/voc/fasterrcnn-glr1e_2-ch-no2svr-s10k-i20-clip  NET_G.INTERVAL 20  NET_G.START_ITER 10000  NET_G.ONLY_G True NET_G.MASK_CLIP True NET_G.G_MODE 'channel'
