...
python tools/plain_train_net_wG.py --config-file configs/faster-rcnn-g/Net-G-lr1e-2.yaml --config-det configs/faster-rcnn-g/voc_faster_rcnn_R_50_FPN.yaml --num-gpus 2 OUTPUT_DIR output/voc/fasterrcnn-glr1e_2-s10k-i50-clip  NET_G.INTERVAL 50  NET_G.START_ITER 10000  NET_G.ONLY_G True NET_G.MASK_CLIP True
