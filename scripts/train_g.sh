python tools/plain_train_G.py --config-file configs/Net-G.yaml --config-det configs/COCO-Detection/faster_rcnn_R_50_FPN_1x_trained.yaml --num-gpus 4 OUTPUT_DIR output/netG_res_lr1e-2 NET_G.MASKTYPE 'residual'
